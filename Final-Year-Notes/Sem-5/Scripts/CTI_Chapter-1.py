...
def ocr_pdf_full(pdf_path, output_path):
    try:
        ...
        with open(output_path, "w") as out:
            ...
            # Re-append enrichment if it existed
            # (We are overwriting, so we should add it back if we want, or just let the user know)
            # For now, I'll just write the text. I can append enrichment later or hardcode it here.
